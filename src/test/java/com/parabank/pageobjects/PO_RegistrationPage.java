 ...
 */
public class PO_RegistrationPage {
	...
	public PO_RegistrationPage(WebDriver driver) {
		this.driver = driver;
	...
	public PO_RegistrationPage enterFirstName(String firstName) {
		wait.until(ExpectedConditions.visibilityOf(firstNameInput)).clear();
		firstNameInput.sendKeys(firstName);
		return this;
	}

	public PO_RegistrationPage enterLastName(String lastName) {
		lastNameInput.clear();
		lastNameInput.sendKeys(lastName);
		return this;
	}

	public PO_RegistrationPage enterAddress(String address) {
		addressInput.clear();
		addressInput.sendKeys(address);
		return this;
	}

	public PO_RegistrationPage enterCity(String city) {
		cityInput.clear();
		cityInput.sendKeys(city);
		return this;
	}

	public PO_RegistrationPage enterState(String state) {
		stateInput.clear();
		stateInput.sendKeys(state);
		return this;
	}

	public PO_RegistrationPage enterZipCode(String zipCode) {
		zipCodeInput.clear();
		zipCodeInput.sendKeys(zipCode);
		return this;
	}

	public PO_RegistrationPage enterPhoneNumber(String phoneNumber) {
		phoneNumberInput.clear();
		phoneNumberInput.sendKeys(phoneNumber);
		return this;
	}

	public PO_RegistrationPage enterSsn(String ssn) {
		ssnInput.clear();
		ssnInput.sendKeys(ssn);
		return this;
	}

	public PO_RegistrationPage enterUsername(String username) {
		usernameInput.clear();
		usernameInput.sendKeys(username);
		return this;
	}

	public PO_RegistrationPage enterPassword(String password) {
		passwordInput.clear();
		passwordInput.sendKeys(password);
		return this;
	}

	public PO_RegistrationPage enterConfirmPassword(String confirmPassword) {
